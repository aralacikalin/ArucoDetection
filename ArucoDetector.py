...
arucoDict="DICT_4X4_1000"
if ARUCO_DICT.get(arucoDict, None) is None:
...
# cv2.namedWindow("Rejected Markers", cv2.WND_PROP_FULLSCREEN)
# cv2.setWindowProperty("Rejected Markers",cv2.WND_PROP_FULLSCREEN,cv2.WINDOW_FULLSCREEN)
# cv2.namedWindow("Detected Markers", cv2.WND_PROP_FULLSCREEN)
# cv2.setWindowProperty("Detected Markers",cv2.WND_PROP_FULLSCREEN,cv2.WINDOW_FULLSCREEN)
